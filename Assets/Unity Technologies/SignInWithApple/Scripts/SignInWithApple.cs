    ...
    public class SignInWithApple : MonoBehaviour
    {
        ...
        private static void LoginCompletedCallback(int result, [MarshalAs(UnmanagedType.Struct)]UserInfo info)
        {
            ...
            if (result != 0)
            {
                ...
                //SignInWithAppleTest._S.userIdText.text = info.userId;
                SignInWithAppleTest._S.userIdText.text = args.userInfo.userId;
                SignInWithAppleTest._S.displayName.text = args.userInfo.displayName;
                SignInWithAppleTest._S.emailText.text = args.userInfo.email;
                //SignInWithAppleTest._S.userIdText.text = info.userId;
                //SignInWithAppleTest._S.displayName.text = info.displayName;
                //SignInWithAppleTest._S.emailText.text = info.email;
            }
            else
            {
